...
// JHS_Core_UpgradeEnoughCredits <upgradeId>
public class JHS_Core_UpgradeEnoughCredits extends BaseCommandPlugin {
    ...
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
        ...
        String targetId = Global.getSector().getMemoryWithoutUpdate().getString(memberFlag);
